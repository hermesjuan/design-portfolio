...
const Beta = () => (
    <Layout>
        ...
        <CasesSection>
            ...
            <p>This project wasn't exactly UI intense, but visual design was an important factor. As a founder having the ability to put a deck quickly to attract the first facilitators was pretty handy. Also gave me the liberty to do the web on no-code platforms (first Squarespace, and then Wix) pretty much by myself.</p>
